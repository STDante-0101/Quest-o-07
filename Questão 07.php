...
$SuperHeroi = new SuperHeroi('001','Aragorgue', 'Rei dos Homens', 1000, 1000, 'Terra Media');
$SuperHeroi = new SuperHeroi('002','Soul of cinder', 'Aspecto das cinzas', 1000, 1000, 'Primeira Fornalha');
$SuperHeroi = new SuperHeroi('003','Shyavanna', 'Virar Dragão', 1000, 1000, 'Demacia');
$SuperHeroi = new SuperHeroi('004','Atem (Yu-gi)', 'Modelar o destino', 1000, 1000, 'Egito- Antigo');
?>